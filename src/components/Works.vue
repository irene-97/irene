	...
	<div class="block-works" id="works">
		<div class="container">
			<h2 :class="[{'info-text-open': isInfoVisible}]">
				...
				/>
				<div class="info-text">
					Ниже представлена лишь небольшая часть работ, в&nbsp;которую не&nbsp;входят проекты, разработанные под <nobr>NDA-соглашением</nobr>
				</div>
			</h2>
			<div class="works">
				<Work
	...
	export default {
		...
		data() {
			return {
				...
				list: [
					{
						href: 'https://irinely.github.io/lean/',
						year: '2019',
						fullDate: 'июнь 2019',
						src: 'lean.jpg',
						alt: 'Lean',
						text: 'Вёрстка и frontend-часть сайта «Lean» (React)',
					},
					{
						href: 'https://irinely.github.io/cs-landing/',
						year: '2019',
						fullDate: 'июнь - июль 2019',
						src: 'creatives.jpg',
						alt: 'Creatives',
						text: 'Вёрстка сайта «CS Creatives» (React)',
					},
					{
					...
					{
						href: 'http://www.premia-zakupki.ru/',
						year: '2016',
						fullDate: 'июль 2016',
						src: 'premia.jpg',
						alt: 'Премия',
					...
					{
						href: 'https://www.birtrans.msk.ru/',
						year: '2016',
					...
					{
						href: 'https://irinely.github.io/v-bank/',
						year: '2018',
						fullDate: 'июнь 2018',
						src: 'vbank.jpg',
						alt: 'Банк',
